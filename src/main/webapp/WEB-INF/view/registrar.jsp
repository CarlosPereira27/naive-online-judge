...
<body>
	...
	<div class="container">
		...
		<form:form action="registrar" modelAttribute="usuario" method="POST"
			...
			<form:label for="nome" class="sr-only" path="nome">Nome</form:label>
			<form:input type="text" id="nome" class="form-control"
				placeholder="Nome" required="true" autofocus="" path="nome" />
			...
			<form:label for="inputPassword" class="sr-only" path="senha">Senha</form:label>
		...
		<br>
		<c:url var="logarLink" value="login" />
		<div align="center">
			<a href="${logarLink}">Logar</a>
		</div>
